...
void aes_enc_sw( aes_context *ctx, uint8 input[16], uint8 output[16] )
{
    uint32 *RK, X0, X1, X2, X3, Y0, Y1, Y2, Y3;

    RK = ctx->erk;

    GET_UINT32_aes( X0, input,  0 ); X0 ^= RK[0];
    GET_UINT32_aes( X1, input,  4 ); X1 ^= RK[1];
    GET_UINT32_aes( X2, input,  8 ); X2 ^= RK[2];
    GET_UINT32_aes( X3, input, 12 ); X3 ^= RK[3];
...
{                                               \
    ...
    PUT_UINT32_aes( X0, output,  0 );
    PUT_UINT32_aes( X1, output,  4 );
    PUT_UINT32_aes( X2, output,  8 );
    PUT_UINT32_aes( X3, output, 12 );
} //aes_enc_sw

/* AES 128-bit block decryption routine */
void aes_dec_sw( aes_context *ctx, uint8 input[16], uint8 output[16] )
{
    uint32 *RK, X0, X1, X2, X3, Y0, Y1, Y2, Y3;
