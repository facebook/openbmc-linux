...
/*
 * Hardware monitoring driver for LTC4282 and compatible chips.
 *
...
static struct ltc4282_data *ltc4282_update_device(struct device *dev)
{
	...
	/* Rate limit the updates to a second */
...
static ssize_t ltc4282_set_value(struct device *dev,
		...
		const char *buf, size_t count)
{
	...
	case ltc4282_vin_min:
		i2c_smbus_write_byte_data(client,
				LTC4282_VGPIO_ALARM_MIN, (val & 0xFF00) >> 8);
		break;
	case ltc4282_vin_max:
		i2c_smbus_write_byte_data(client,
				LTC4282_VGPIO_ALARM_MAX, (val & 0xFF00) >> 8);
		break;
	case ltc4282_reg_curr_min:
		i2c_smbus_write_byte_data(client,
				LTC4282_VSOURCE_ALARM_MIN, (val & 0xFF00) >> 8);
		break;
	case ltc4282_reg_curr_max:
		i2c_smbus_write_byte_data(client,
				LTC4282_VSOURCE_ALARM_MAX, (val & 0xFF00) >> 8);
		break;
	case ltc4282_temp_min:
		i2c_smbus_write_byte_data(client,
				LTC4282_VSENSE_ALARM_MIN, (val & 0xFF00) >> 8);
		break;
	case ltc4282_temp_max:
		i2c_smbus_write_byte_data(client,
				LTC4282_VSENSE_ALARM_MAX, (val & 0xFF00) >> 8);
		break;
				  ...
				  struct device_attribute *dev_attr, char *buf)
{
	...
	if (fault)        /* Clear reported faults in chip register */
		i2c_smbus_write_byte_data(data->client, LTC4282_ADC_ALERT_LOG,
				~fault & val);
				  ...
				  struct device_attribute *dev_attr, char *buf)
{
	...
	fault = val & (1 << attr->index);
	if (fault) /* Clear reported faults in chip register */
		i2c_smbus_write_byte_data(data->client, LTC4282_FAULT_LOG,
				~fault & val);
...
static ssize_t ltc4282_do_reboot(struct device *dev,
		struct device_attribute *dev_attr,
		const char *buf, size_t count)
{
	struct sensor_device_attribute *attr = to_sensor_dev_attr(dev_attr);
	...
	if (val == 1) {
		int reg_var = i2c_smbus_read_byte_data(client,
				LTC4282_ADC_CONTROL);
 ...
 * Input voltages.
 */
static SENSOR_DEVICE_ATTR(in1_input, 0444, ltc4282_show_value, NULL,
	      ltc4282_vin);
static SENSOR_DEVICE_ATTR(in2_input, 0444, ltc4282_show_value, NULL,
	      ltc4282_vout);

/*
 * Voltages alarm threshold.
 */
static SENSOR_DEVICE_ATTR(in1_min, 0644, ltc4282_show_value,
		ltc4282_set_value, ltc4282_vin_min);
static SENSOR_DEVICE_ATTR(in1_max, 0644, ltc4282_show_value,
		ltc4282_set_value, ltc4282_vin_max);
static SENSOR_DEVICE_ATTR(in2_min, 0644, ltc4282_show_value,
		ltc4282_set_value, ltc4282_vout_min);
static SENSOR_DEVICE_ATTR(in2_max, 0644, ltc4282_show_value,
		ltc4282_set_value, ltc4282_vout_max);

/* Currents (via sense resistor) */
static SENSOR_DEVICE_ATTR(curr1_input, 0444, ltc4282_show_value, NULL,
	      ltc4282_curr);
/* Current alarm threshold */
static SENSOR_DEVICE_ATTR(curr1_min, 0644, ltc4282_show_value,
		ltc4282_set_value, ltc4282_curr_min);
static SENSOR_DEVICE_ATTR(curr1_max, 0644, ltc4282_show_value,
		ltc4282_set_value, ltc4282_curr_max);
...
static SENSOR_DEVICE_ATTR(temp1_input, 0444, ltc4282_show_value, NULL,
	      ltc4282_temp);
static SENSOR_DEVICE_ATTR(temp1_min, 0644, ltc4282_show_value,
		ltc4282_set_value, ltc4282_temp_min);
static SENSOR_DEVICE_ATTR(temp1_max, 0644, ltc4282_show_value,
		ltc4282_set_value, ltc4282_temp_max);

/* Fault log system file nodes */
static SENSOR_DEVICE_ATTR(fault_ov, 0444, ltc4282_show_fault, NULL,
	      FAULT_OV);
static SENSOR_DEVICE_ATTR(fault_uv, 0444, ltc4282_show_fault, NULL,
	      FAULT_UV);
static SENSOR_DEVICE_ATTR(fault_oc, 0444, ltc4282_show_fault, NULL,
	      FAULT_OC);
static SENSOR_DEVICE_ATTR(fault_power, 0444, ltc4282_show_fault, NULL,
	      FAULT_POWER);
static SENSOR_DEVICE_ATTR(on_fault, 0444, ltc4282_show_fault, NULL,
	      ON_FAULT);
static SENSOR_DEVICE_ATTR(fault_fet_short, 0444, ltc4282_show_fault, NULL,
	      FAULT_FET_SHORT);
static SENSOR_DEVICE_ATTR(fault_fet_bad, 0444, ltc4282_show_fault, NULL,
	      FAULT_FET_BAD);
static SENSOR_DEVICE_ATTR(eeprom_done, 0444, ltc4282_show_fault, NULL,
	      EEPROM_DONE);

/* ADC alert system file nodes */
static SENSOR_DEVICE_ATTR(power_alarm_high, 0444, ltc4282_show_alarm, NULL,
	      POWER_ALARM_HIGH);
static SENSOR_DEVICE_ATTR(power_alarm_low, 0444, ltc4282_show_alarm, NULL,
	      POWER_ALARM_LOW);
static SENSOR_DEVICE_ATTR(vsense_alarm_high, 0444, ltc4282_show_alarm, NULL,
	      VSENSE_ALARM_HIGH);
static SENSOR_DEVICE_ATTR(vsense_alarm_low, 0444, ltc4282_show_alarm, NULL,
	      VSENSE_ALARM_LOW);
static SENSOR_DEVICE_ATTR(vsource_alarm_high, 0444, ltc4282_show_alarm, NULL,
	      VSOURCE_ALARM_HIGH);
static SENSOR_DEVICE_ATTR(vsource_alarm_low, 0444, ltc4282_show_alarm, NULL,
	      VSOURCE_ALARM_LOW);
static SENSOR_DEVICE_ATTR(gpio_alarm_high, 0444, ltc4282_show_alarm, NULL,
	      GPIO_ALARM_HIGH);
static SENSOR_DEVICE_ATTR(gpio_alarm_low, 0444, ltc4282_show_alarm, NULL,
	      GPIO_ALARM_LOW);

/* Fault status system file nodes */
static SENSOR_DEVICE_ATTR(on_status, 0444, ltc4282_show_status, NULL,
	      ON_STATUS);
static SENSOR_DEVICE_ATTR(fet_bad, 0444, ltc4282_show_status, NULL,
	      FET_BAD);
static SENSOR_DEVICE_ATTR(fet_short, 0444, ltc4282_show_status, NULL,
	      FET_SHORT);
static SENSOR_DEVICE_ATTR(on_pin_status, 0444, ltc4282_show_status, NULL,
	      ON_PIN_STATUS);
static SENSOR_DEVICE_ATTR(power_good, 0444, ltc4282_show_status, NULL,
	      POWER_GOOD);
static SENSOR_DEVICE_ATTR(oc_status, 0444, ltc4282_show_status, NULL,
	      OC_STATUS);
static SENSOR_DEVICE_ATTR(uv_status, 0444, ltc4282_show_status, NULL,
	      UV_STATUS);
static SENSOR_DEVICE_ATTR(ov_status, 0444, ltc4282_show_status, NULL,
	      OV_STATUS);
static SENSOR_DEVICE_ATTR(gpio3_status, 0444, ltc4282_show_status, NULL,
	      GPIO3_STATUS);
static SENSOR_DEVICE_ATTR(gpio2_status, 0444, ltc4282_show_status, NULL,
	      GPIO2_STATUS);
static SENSOR_DEVICE_ATTR(gpio1_status, 0444, ltc4282_show_status, NULL,
	      GPIO1_STATUS);
static SENSOR_DEVICE_ATTR(alert_status, 0444, ltc4282_show_status, NULL,
	      ALERT_STATUS);
static SENSOR_DEVICE_ATTR(eeprom_busy, 0444, ltc4282_show_status, NULL,
	      EEPROM_BUSY);
static SENSOR_DEVICE_ATTR(adc_idle, 0444, ltc4282_show_status, NULL,
	      ADC_IDLE);
static SENSOR_DEVICE_ATTR(ticker_overflow, 0444, ltc4282_show_status, NULL,
	      TICKER_OVERFLOW);
static SENSOR_DEVICE_ATTR(meter_overflow, 0444, ltc4282_show_status, NULL,
	      METER_OVERFLOW);

/* expose fet_bad_status fet_short_status as voltage */
static SENSOR_DEVICE_ATTR(in3_input, 0444, ltc4282_show_fet_as_voltage, NULL,
			FET_BAD);
static SENSOR_DEVICE_ATTR(in4_input, 0444, ltc4282_show_fet_as_voltage, NULL,
			FET_SHORT);

static SENSOR_DEVICE_ATTR(reboot, 0200, NULL, ltc4282_do_reboot, 0);
