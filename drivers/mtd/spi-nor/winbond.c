...
static int winbond_nor_select_die(struct spi_nor *nor, u8 die)
{
	...
	if (nor->spimem) {
		...
		ret = nor->controller_ops->write_reg(nor, WINBOND_NOR_OP_SELDIE,
						     nor->bouncebuf, 1);
	}
...
static int w25q0xjv_post_bfpt_fixups(
	struct spi_nor *nor, const struct sfdp_parameter_header *bfpt_header,
	const struct sfdp_bfpt *bfpt, struct spi_nor_flash_parameter *params)
{
	/*
...
static const struct flash_info winbond_parts[] = {
	...
	{ "w25q256jw", INFO(0xef6019, 0, 64 * 1024, 512,
			     SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ "w25q512nwq",INFO(0xef6020, 0, 64 * 1024, 1024, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB) },
	{ "w25q512nwm",INFO(0xef8020, 0, 64 * 1024, 1024, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB) },
	...
	{ "w25q01jv-im", INFO(0xef7021, 0, 64 * 1024, 2048, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
};
