...
// --------------------------------------------------------------------
#define CONFIG_FTGMAC_DES_FMT_NC1
#ifdef CONFIG_FTGMAC_DES_FMT_NC1
#define ZeroCopy
// Defining _PHY_MARVELL includes code that isn't needed for Broadcom.
#define CONFIG_FTGMAC_PHY_MARVELL
#define HAVE_MULTICAST
#endif

#ifdef CONFIG_CPU_FA52x_DCE
#define DescpCacheable
#endif
...
#endif // end of #ifdef CONFIG_FTGMAC_DES_FMT_NC1
...
#endif //#ifdef CONFIG_FTGMAC_DES_FMT_NC1
