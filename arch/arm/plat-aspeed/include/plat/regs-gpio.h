...
#define AST_SGPIO_INT_EN					0x04
#define AST_SGPIO_INT_SEN_T0				0x08
#define AST_SGPIO_INT_SEN_T1				0x0c
#define AST_SGPIO_INT_SEN_T2				0x10
#define AST_SGPIO_INT_STS					0x14
#define AST_SGPIO_RST_TOR					0x18
#define AST_EXT_SGPIO_DATA					0x1c
#define AST_EXT_SGPIO_INT_EN				0x20
#define AST_EXT_SGPIO_INT_SEN_T0			0x24
#define AST_EXT_SGPIO_INT_SEN_T1			0x28
#define AST_EXT_SGPIO_INT_SEN_T2			0x2c
#define AST_EXT_SGPIO_INT_STS				0x30
#define AST_EXT_SGPIO_RST_TOR				0x34
#define AST_SGPIO_CTRL						0x54
#define AST_SGPIO_DATA_READ					0x70
#define AST_EXT_SGPIO_DAT					0x74

//Serial GPIO Slave Monitor
#define AST_SGPIO_SLAVE_DATA_INIT			0x00
#define AST_SGPIO_SLAVE_DATA_TARGET		0x04
#define AST_SGPIO_SLAVE_DATA_LOAD			0x08
#define AST_SGPIO_SLAVE_INT_EN0				0x0c
#define AST_SGPIO_SLAVE_INT_EN1				0x10
#define AST_SGPIO_SLAVE_INT_EN2				0x14
#define AST_SGPIO_SLAVE_INT_STS0			0x18
#define AST_SGPIO_SLAVE_INT_STS1			0x1c
#define AST_SGPIO_SLAVE_INT_STS2			0x20
/**********************************************************************************/
...
#define AST_SGPIO_PIN(x)				(x << 6)
#define AST_SGPIO_ENABLE				1
