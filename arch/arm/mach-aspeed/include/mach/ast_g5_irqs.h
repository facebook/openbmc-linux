...
#define NR_IRQS							(IRQ_PCIE_CHAIN_START + ARCH_NR_PCIE + AST_NUM_MSI_IRQS  + (AST_CVIC_NUM * MAX_AST1070_NR))
...
#define IRQ_EGFX_CHAIN_START			(IRQ_VHUB_CHAIN_START + ARCH_NR_VHUB + (AST_CVIC_NUM * MAX_AST1070_NR))

#define ARCH_NR_VHUB 					(5) 

#define IRQ_VHUB_CHAIN_START			(IRQ_SDHCI_CHAIN_START + ARCH_NR_SDHCI + (AST_CVIC_NUM * MAX_AST1070_NR))
