...
#define NR_IRQS							(AST_VIC_NUM + AST_FIQ_NUM + ARCH_NR_I2C + ARCH_NR_GPIOS + ARCH_NR_SGPIOS + ARCH_NR_SDHCI + ARCH_NR_VHUB + ARCH_NR_EGFX + ARCH_NR_PCIE + AST_NUM_MSI_IRQS  + (AST_CVIC_NUM * MAX_AST1070_NR))
...
#define IRQ_PCIE_CHAIN_START			(AST_VIC_NUM + AST_FIQ_NUM + ARCH_NR_I2C + ARCH_NR_GPIOS + ARCH_NR_SGPIOS + ARCH_NR_SDHCI + ARCH_NR_VHUB  + (AST_CVIC_NUM * MAX_AST1070_NR))
...
#define IRQ_EGFX_CHAIN_START			(AST_VIC_NUM + AST_FIQ_NUM + ARCH_NR_I2C + ARCH_NR_GPIOS + ARCH_NR_SGPIOS  + ARCH_NR_SDHCI + ARCH_NR_VHUB + (AST_CVIC_NUM * MAX_AST1070_NR))
